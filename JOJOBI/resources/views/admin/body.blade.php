      ...
      <div class="col-md-3 col-sm-6">
        <div class="statistic-block block">
          <div class="progress-details d-flex align-items-end justify-content-between">
            <div class="title">
              <div class="icon" style="display:flex; justify-content:space-between;">
                ...
                <a href="{{ route('admin.preview-pdf') }}" target="_blank"><i class="bi bi-cloud-download"></i></a>
              </div>
          ...
          <div class="progress progress-template">
            <div role="progressbar" style="width: {{ $progressPercentages['users'] }}%;" aria-valuenow="{{ $progressPercentages['users'] }}"
              aria-valuemin="0" aria-valuemax="100" class="progress-bar progress-bar-template dashbg-1"></div>
          </div>
        </div>
      </div>
      <div class="col-md-3 col-sm-6">
        <div class="statistic-block block">
          <div class="progress-details d-flex align-items-end justify-content-between">
            <div class="title">
              <div class="icon" style="display:flex; justify-content:space-between;">
                ...
                <a href="{{ route('admin.products.download-pdf') }}" target="_blank">
          ...
          <div class="progress progress-template">
            <div role="progressbar" style="width: {{ $progressPercentages['products'] }}%;" aria-valuenow="{{ $progressPercentages['products'] }}" aria-valuemin="0" aria-valuemax="100"
