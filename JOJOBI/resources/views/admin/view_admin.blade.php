...
<!-- Search User Form -->
<h1 class="text_cat">Search Admin</h1>
...
@if ($admins->total() > 0)
    <p class="text-center">Total results found: {{ $admins->total() }}</p>
@endif


<h1 class="text_cat">All Admins</h1>
<!-- Admins Table -->
        ...
        <tbody>
            @foreach ($admins as $admin)
                <tr>
                    ...
                    <td>
                        <a class="btn btn-success" href="{{ route('admin.user.update', $admin->uuid) }}">Update</a>
                        <a class="btn btn-danger" onclick="confirmation(event)"
                            href="{{ route('admin.admin.delete', $admin->uuid) }}">Delete</a>
                    </td>
                </tr>
            @endforeach
        </tbody>
